...
function startGame() {
  ...
  roadImg.onload = () => {
    ...
    carImg.onload = () => {
      ...
      const carY = canvas.height - carImg.height + 150;
      ...
      const displayRestartButton = () => {
        ...
        restartButton.style.bottom = "20px"; // Adjust the vertical position
        restartButton.style.left = "calc(50% - 50px)"; // Center the button horizontally
